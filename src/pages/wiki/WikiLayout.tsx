...
export default function WikiLayout() {
  ...
  const isWikiHome = pathname.replace(/\/$/, '') === '/wiki';

  return (
    <div className="min-h-screen bg-[#eaecf0] text-[#202122]">
      ...
      <main className="max-w-5xl mx-auto px-3 sm:px-4 py-6 md:py-8">
        <div className="wiki-sheet rounded border border-[#a7d7f9] bg-white shadow-[0_1px_3px_rgba(0,0,0,.08)] px-4 py-6 sm:px-8 sm:py-8 md:px-10 md:py-10">
          <Outlet />
        </div>
      </main>

      <footer className="max-w-5xl mx-auto px-4 pb-8 text-center text-xs text-[#72777d] font-body">
